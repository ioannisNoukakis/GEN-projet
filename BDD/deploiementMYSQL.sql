...
CREATE TABLE Personnage (
    ...
    NOM_RACE CHAR(30) NOT NULL,
    NOM_CLASSE CHAR(30) NOT NULL,
    NOM_COMPETENCE1 CHAR(30) NOT NULL,
    NOM_COMPETENCE2 CHAR(30) NOT NULL,
    NOM_COMPETENCE3 CHAR(30) NOT NULL,
    NOM_COMPETENCE4 CHAR(30) NOT NULL,
...
CREATE TABLE Utilisateur (
    ...
    ID_PERSONNAGE INT DEFAULT 0,
	pseudonyme CHAR(30) NOT NULL UNIQUE,
	motDePasse CHAR(30) NOT NULL,
    adresseIP CHAR(30) NOT NULL,
    banni CHAR(1),
...
CREATE TABLE Combat (
	...
	CONSTRAINT Combat_Utilisateur_FK FOREIGN KEY (ID_GAGNANT) REFERENCES Utilisateur(ID_UTILISATEUR)
);
