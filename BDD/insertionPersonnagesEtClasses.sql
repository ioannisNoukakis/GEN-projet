...
VALUES ("Marguerite", "Tauren", "Paladin", "Mon bouclier pour argus!", "Sainte pelle", "Toi pas passer", "Pichnette dans ton noeil");

INSERT INTO Personnage(nom,NOM_RACE, NOM_CLASSE, NOM_COMPETENCE1, NOM_COMPETENCE2, NOM_COMPETENCE3, NOM_COMPETENCE4)
VALUES ("InstallShieldWizard", "Humain", "Illusionniste", "Kiss cool FrrRrroid", "Lacher d'Olaf", "Sainte pelle", "Imposant pic de glace");

INSERT INTO Personnage(nom,NOM_RACE, NOM_CLASSE, NOM_COMPETENCE1, NOM_COMPETENCE2, NOM_COMPETENCE3, NOM_COMPETENCE4)
VALUES ("Nictalop", "Elfe", "Rodeur", "Crayon pointu", "Lancer de crayon", "Coup de bide", "Baffe baffe");

INSERT INTO Personnage(nom,NOM_RACE, NOM_CLASSE, NOM_COMPETENCE1, NOM_COMPETENCE2, NOM_COMPETENCE3, NOM_COMPETENCE4)
VALUES ("Groubi", "Nain", "Guerrier","Coup d'artichaud", "Crachat dégoutant", "Coup de bouclier", "Baffe baffe");

INSERT INTO Personnage(nom,NOM_RACE, NOM_CLASSE, NOM_COMPETENCE1, NOM_COMPETENCE2, NOM_COMPETENCE3, NOM_COMPETENCE4)
VALUES ("NootNoot", "Pingouin", "Mage", "Flames d'Azinoth", "Lacher d'Olaf", "Chili con carne", "Feux de l'amour");

INSERT INTO Personnage(nom,NOM_RACE, NOM_CLASSE, NOM_COMPETENCE1, NOM_COMPETENCE2, NOM_COMPETENCE3, NOM_COMPETENCE4)
VALUES ("Philibert", "Homme Poireau", "Barbare", "Coup d'artichaud", "Coup de bide", "Toi pas passer", "Crachat dégoutant");

INSERT INTO Personnage(nom,NOM_RACE, NOM_CLASSE, NOM_COMPETENCE1, NOM_COMPETENCE2, NOM_COMPETENCE3, NOM_COMPETENCE4)
VALUES ("Framboisier", "Ent", "Prêtre", "Bug", "Sainte pelle", "Pichnette dans ton noeil", "Crayon pointu");

INSERT INTO Personnage(nom,NOM_RACE, NOM_CLASSE, NOM_COMPETENCE1, NOM_COMPETENCE2, NOM_COMPETENCE3, NOM_COMPETENCE4)
VALUES ("Kicoup", "Orque", "Combatant du Fenouil", "Coup d'artichaud", "Crachat dégoutant", "Toi pas passer", "Coup de bouclier");
